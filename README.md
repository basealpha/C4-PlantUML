...
```c#
!include https://raw.githubusercontent.com/basealpha/C4-PlantUML/master/C4_Container.puml
```
...
* System Context & System Landscape diagrams
  * Import: `!include https://raw.githubusercontent.com/basealpha/C4-PlantUML/master/C4_Context.puml`
  * Macros: 
    ...
    * `System_Boundary` 
* Container diagram
  * Import: `!include https://raw.githubusercontent.com/basealpha/C4-PlantUML/master/C4_Container.puml`
  * Additional Macros: 
...
* Component diagram
  * Import: `!include https://raw.githubusercontent.com/basealpha/C4-PlantUML/master/C4_Component.puml`
  * Additional Macros: 
    ...
    * `ComponentQueue_Ext`
* Dynamic diagram
  * Import: `!include https://raw.githubusercontent.com/basealpha/C4-PlantUML/master/C4_Dynamic.puml`
  * Additional Macros: 
    * `RelIndex(index, from, to, label)`
    * `increment()`
    * `setIndex(number)`
* Deployment diagram
  * Import: `!include https://raw.githubusercontent.com/basealpha/C4-PlantUML/master/C4_Deployment.puml`
  * Additional Macros: 
